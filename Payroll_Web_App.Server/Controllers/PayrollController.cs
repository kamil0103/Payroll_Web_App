...
namespace Payroll_Web_App.Server.Controllers
{
    ...
    public class PayrollController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetPayslipHtml(int id)
        {
            ...
            html.Append("<tr><th>Gross Pay</th><td class='right'>" + payroll.GrossPay.ToString("C") + "</td></tr>");
            html.Append("<tr><th>Tax</th><td class='right'>-" + payroll.TaxDeductions.ToString("C") + "</td></tr>");
            html.Append("<tr><th>Benefits</th><td class='right'>-" + payroll.BenefitsDeductions.ToString("C") + "</td></tr>");
            html.Append("<tr><th><strong>Net Pay</strong></th><td class='right'><strong>" + payroll.NetPay.ToString("C") + "</strong></td></tr>");
